...
//        TypedArray typedArray = mContext.obtainStyledAttributes(attrs, R.styleabl.SquareProcessView);
//        currentPogress = typedArray.getInteger(R.styleable.SquareProcessView_currentPogress, 0);
//        strokeColor = typedArray.getColor(R.styleable.SquareProcessView_strokeColor, ContextCompat.getColor(mContext, R.color.green));
//        strokeWith = typedArray.getDimension(R.styleable.SquareProcessView_strokeWith, strokeWith);
//        progressColor = typedArray.getColor(R.styleable.SquareProcessView_progressColor, ContextCompat.getColor(mContext, R.color.purple_200));
//        textColor = typedArray.getColor(R.styleable.SquareProcessView_textColor, ContextCompat.getColor(mContext, R.color.teal_200));
//        textSize = typedArray.getDimension(R.styleable.SquareProcessView_textSize, textSize);
        currentPogress = 60;
        strokeColor = ContextCompat.getColor(mContext, R.color.green);
        strokeWith = 100;
        progressColor = ContextCompat.getColor(mContext, R.color.purple_200);
        textColor = ContextCompat.getColor(mContext, R.color.teal_200);
        textSize = 14;
        initPaints();
    }
